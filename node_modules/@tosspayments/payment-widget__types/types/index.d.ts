...
interface PaymentMethodsWidget {
    ...
    on: {
        (eventName: 'customRequest' | 'customPaymentMethodSelect' | 'customPaymentMethodUnselect', callback: (selectedPaymentMethod: string) => unknown): void;
        (eventName: 'ready', callback: () => unknown): void;
    };
